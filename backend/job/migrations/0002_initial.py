...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="sphere",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.SET_NULL, to="job.sphere"
            ),
        ),
        migrations.AddField(
            model_name="message",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="job.instrument", verbose_name="Список инструментов"
            ),
        ),
        migrations.AddField(
            model_name="case",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("initiator", "receiver"), name="unique_initiator_receiver"
            ),
        ),
    ]
